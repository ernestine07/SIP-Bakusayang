                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-header">
                                <h2>Buat Pesanan</h2>
                                <div class="card-body">
                                    <form method="post" action="{{ route('cart1') }}" enctype="multipart/form-data">
                                        @csrf                                    
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="select" class=" form-control-label">Menu<sup class="text-danger">*</sup></label>
                                            </div>
                                            <div class="col-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-data-feature">
                                                                <form action="{{ route('cart2', $value->id) }}"
                            ...
                            <div class="col col-lg-4 col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="{{route('pesanan')}}" method="post" novalidate="novalidate">
                                            @csrf
