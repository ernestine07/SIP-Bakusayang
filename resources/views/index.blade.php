...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                            <img src="{{asset('template/images/icon/logo.jpg')}}" alt="CoolAdmin" />
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="calendar.html">
                                <i class="fas fa-calendar-alt"></i>Transaksi</a>
                        </li>
                        <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>Data User</a>
                        </li>
                        <li>
                            <a href="map.html">
                        ...
                        <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>Kritik dan Saran</a>
                        </li>
                        <li>
                            <a href="map.html">
                                <i class="fas fa-map-marker-alt"></i>Tentang</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('template/images/icon/logo (2).png')}}" width="75" height="75" alt="Logo cafe" />
                </a>
            </div>
